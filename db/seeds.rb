...
Book.where(title: 'Death on the Nile').first_or_create(isbn: '978-0062073556', author_id: @agatha.id, genre: 'Mystery', abstract: '', pages: 356, image_cover_url: '', total_in_library: 5)
Book.where(title: 'Murder on the Orient Express').first_or_create(isbn: '978-0062073501', author_id:  @agatha.id, genre: 'Mystery', abstract: '', pages: 336, image_cover_url: '', total_in_library: 3)
Book.where(title: 'Of Mice and Men').first_or_create(isbn: '978-0749717100',  author_id:  @stein.id, genre: 'Novella', abstract: '', pages: 112, image_cover_url: '', total_in_library: 6)
Book.where(title: 'Adventures of Huckleberry Finn').first_or_create(isbn: '978-0486280615',  author_id:  @twain.id, genre: 'Action & Adventure', abstract: '', pages: 224, image_cover_url: '', total_in_library: 3)
Book.where(title: 'The Hunt for Red October').first_or_create(isbn: '978-0425240335', author_id:  @clancy.id, genre: 'Techno-thriller', abstract: '', pages: 656, image_cover_url: '', total_in_library: 5)
Book.where(title: 'War and Peace').first_or_create(isbn: '978-1400079988', author_id:  @leo.id, genre: 'Historical Fiction', abstract: '', pages: 1296, image_cover_url: '', total_in_library: 4)
Book.where(title: 'The Jungle Book').first_or_create(isbn: '978-1503332546', author_id:  @kip.id, genre: 'Action & Adventure', abstract: '', pages: 92, image_cover_url: '', total_in_library: 4)
Book.where(title: 'Catcher in the Rye').first_or_create(isbn: '978-0316769488', author_id:  @jd.id, genre: 'Literary Criticism & Theory', abstract: '', pages: 224, image_cover_url: '', total_in_library: 2)
Book.where(title: 'Around the World in 80 Days').first_or_create(isbn: '978-1503215153', author_id:  @verne.id, genre: 'Action & Adventure', abstract: '', pages: 130, image_cover_url: '', total_in_library: 1)
Book.where(title: 'The Hobbit').first_or_create(isbn: '978-0547928227', author_id:  @tolkien.id, genre: 'Science Fiction & Fantasy', abstract: '', pages: 300, image_cover_url: '', total_in_library: 2)
Book.where(title: 'The Silmarillion').first_or_create(isbn: '978-0345325815', author_id:  @tolkien.id, genre: 'Science Fiction & Fantasy', abstract: '', pages: 480, image_cover_url: '', total_in_library: 1)